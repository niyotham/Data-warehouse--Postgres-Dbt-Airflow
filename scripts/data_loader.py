...
class DataLoader():
    ...
    def connect_to_server(self,host:str = "localhost", 
                               port:int=5432, user:str = "warehouse", 
    ...
    def connect_to_mysql_server(self,host:str, port:int, 
          user:str, password:str, dbName:str=None):
        """
        A function that allows you to connect to SQL database
        Args:
            host: ip address or domain
